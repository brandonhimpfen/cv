...
\definecolor{VividPurple}{HTML}{222222}
...
%% behimpfen.bib contains your publications
\addbibresource{behimpfen.bib}

\begin{document}
\name{Brandon Himpfen, C.I.M.}
\tagline{Certificate in Supervisory Management (CSM)\\Certificate in Management and Administration – Chartered Management Program (CMP)}
...
% \location{Sunnyvale, CA}
  \homepage{www.himpfen.com}
  \twitter{@brandonhimpfen}
  \linkedin{brandonhimpfen}
  \github{brandonhimpfen} 
  \orcid{0000-0001-7523-2621}
